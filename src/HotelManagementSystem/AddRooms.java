...
public class AddRooms extends JFrame implements ActionListener {
    ...
    AddRooms(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/bed.jpeg"));
    ...
    public void actionPerformed (ActionEvent ae){
        if(ae.getSource() == add){
            ...
            String avalibility = (String) availablecombo.getSelectedItem();
            ...
            try{
                Conn conn = new Conn();
                String str = "insert into room values ('"+roomnumber+"', '"+avalibility+"', '"+status+"', '"+price+"', '"+type+"')";
